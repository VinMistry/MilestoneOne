...
public class Launch {
  ...
  public static void main(final String[] args) {
    ...
    final CustomerProfile cp1 = new CustomerProfile(c1, vroom1, new Address("BL3 6TS", "31", "Street", "Bolton"));
    final CustomerProfile cp2 = new CustomerProfile(c2, vroom2, new Address("M2 2BT", "1", "Road", "Manchester"));
    final CustomerProfile cp3 = new CustomerProfile(c3, vroom3, new Address("M3 3IS", "90", "Queen", "Manchester"));
